	...
	sections.push({
		items: [
			...
			sectionList([
				...
				'Certified in accordance with the tax law as part of a plan designed to reduce the total annual energy and power costs of the building by a minimum of 25 percent or more in comparison to a reference building meeting the minimum requirements of ASHRAE Standard 90.1.'
			]),		

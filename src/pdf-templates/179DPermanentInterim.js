...
export default async ({ 
	...
	const section_4_1 = [
		...
		sectionParagraph(`The new Lighting systems were completed in ${buildingTypesSubject}. The ASHRAE/ IESNA 90.1 lighting power density number for the buildings are:`)
	]

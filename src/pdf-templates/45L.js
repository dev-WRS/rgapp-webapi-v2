...
export default async ({
	...
	sections.push({
		items: [
			...
			sectionList([
				'Analysis of construction documents to determine whether the energy efficient building envelope components and energy efficient heating or cooling equipment installed meet the required energy efficiency performance measures.',
	...
	sections.push({
		items: [		
			...
			sectionParagraph('In order to be considered a qualified new energy efficient home, a qualified new energy efficient home must receive a written certification that describes its energy-saving features including the energy efficient building envelope components used in its construction and energy efficient heating or cooling equipment that has been installed (Code Sec. 45L(c) and (d)). Further, the dwelling must be located in the United States, must be purchased or acquired by a person from the eligible contractor for use as a residence during the tax year, and must be acquired before January 1, 2023.'),
